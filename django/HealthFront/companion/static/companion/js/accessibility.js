...
const A11Y = (() => {
  ...
  const T = {
    en: {
      ...
      "login.capstone": "Capstone Login",
      "login.capstone_pickpatient": "Pick a patient to demo as",
    ...
    es: {
      ...
      "login.capstone": "Inicio rápido (Capstone)",
      "login.capstone_pickpatient": "Elija un paciente para la demostración",
    ...
    ar: {
      ...
      "login.capstone": "تسجيل الدخول السريع (Capstone)",
      "login.capstone_pickpatient": "اختر مريضًا للعرض التوضيحي",
    ...
    ht: {
      ...
      "login.capstone": "Koneksyon Capstone",
      "login.capstone_pickpatient": "Chwazi yon pasyan pou demo",
